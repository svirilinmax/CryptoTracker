...
from backend.api_gateway.models.schemas import AssetResponse, AssetCreateRequest, AssetUpdateRequest, PriceHistory
from backend.api_gateway.crud.asset import (get_assets_by_user,
